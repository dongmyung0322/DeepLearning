...
from pneumonia_data_custom_dataset import CustomDataset
...
class Pneumonia_Classifier:
    ...
    def train(self, train_loader, val_loader, epochs, optimizer, criterion, start_epoch=0):
        ...
        for epoch in range(start_epoch, epochs):
            ...
            if val_acc > best_val_acc:
                torch.save(self.model.state_dict(), './best_model/pneumonia_best.pt')
            ...
            }, './checkpoints/pneumonia_data_checkpoint.pt')
    ...
    def save_result_to_csv(self):
        ...
        df.to_csv('./loss_acc_result/pneumonia_train_val_result.csv', index=False)
    ...
    def plot_loss(self):
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig('./loss_acc_result/pneumonia_loss_plot.png')
    ...
    def plot_accuracy(self):
        ...
        plt.ylabel('Acc')
        plt.legend()
        plt.savefig('./loss_acc_result/pneumonia_acc_plot.png')
    ...
    def run(self,args):
        ...
        train_dataset = CustomDataset('./data/pneumonia_data/train', transform=train_transforms)
        val_dataset = CustomDataset('./data/pneumonia_data/val', transform=val_transforms)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dir', type=str, default='./data/pneumonia_data/train',
                        help='directory path to training data')
    parser.add_argument('--val_dir', type=str, default='./data/pneumonia_data/valid',
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints/pneumonia_data_checkpoint.pt',
    ...
    # resume = python pneumonia_data_train.py --resume